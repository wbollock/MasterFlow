package wbollock.com.masterflow;
...
import wbollock.com.masterflow.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mItem != null){
            ...
            ((WebView) rootView.findViewById(R.id.detail_area)).setLayerType(rootView.LAYER_TYPE_SOFTWARE, null);
